...
export class CadenceFitFactor extends BaseFactor {
  ...
  protected computeRaw(context: FactorContext): RawFactorResult {
    ...
    const approachComponent = resolves ? APPROACH_RESOLUTION_BONUS * pressure : 0;

    const raw = cadenceComponent + approachComponent;
